        ...
        <div className="relative w-full h-full overflow-hidden">
          ...
          {isSelected && (
            <div className="absolute inset-0 bg-violet-500/10 flex items-center justify-center">
              <div className="w-16 h-16 bg-white backdrop-blur-sm rounded-full flex justify-center items-center shadow-lg animate-pulse">
                <Check size={24} className="text-shadow-violet-600" />
              </div>
            </div>
          )}
          // hover effect
