...
//   // const ThemeSelector = ({ resumeData, setActiveTab, tabValue }) => {
...
//         <button
//           className="w-full sm:w-auto flex-items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-3xl hover:scale-105 transition-all shadow-lg hover:shadow-xl"
