...
const StepProgress = ({ progress }) => {
  return (
    <>
      ...
      <div className="relative w-full h-full bg-white/5 backdrop-blur-2xl overflow-hidden rounded-full border-white/10">
        <div className="absolute inset-o bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 animate-pulse">
          {/* main progress bar */}
          ...
          >
            ...
            <div className="absolute inset-0 opacity-80">
              {[...Array(8)].map((_, i) => {
                <div
                  className="absolute top-1/2 w-2 h-2 bg-white rounded-fullanimate-bubble shadow-lg"
                  key={i}
                  style={{
                    left: `${(i + 1) * 12}%`,
